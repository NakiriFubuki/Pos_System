...
Thank you for considering contributing to the **Mini Market POS System**! Your help is essential for making this project even better. 💖
...
- 🛡️ Use **prepared statements** for all SQL
- 🧼 Escape output with `e()` / `htmlspecialchars`
- 💬 Write clear, concise commit messages
- 📝 Update README screenshots / copy when you change user-facing UI
